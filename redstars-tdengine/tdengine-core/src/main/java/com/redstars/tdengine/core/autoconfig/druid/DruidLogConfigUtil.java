...
import com.redstars.tdengine.core.autoconfig.toolkit.DsConfigUtil;
...
public final class DruidLogConfigUtil {
     ...
     * @return 日志filter
     */
    public static LogFilter initFilter(Class<? extends LogFilter> clazz, Map<String, Object> c) {
        try {
            LogFilter filter = clazz.newInstance();
            Map<String, Object> params = DsConfigUtil.mergeConfig(c);
