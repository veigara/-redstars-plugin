...
import static com.redstars.tdengine.core.autoconfig.druid.DruidConsts.*;
...
public class DruidConfig {
    ...
    /**
     * 根据本地配置结合转换为Properties
     *
     * @return Druid配置
     */
    public Properties toProperties() {
        Properties properties = new Properties();
        Integer initialSize = this.initialSize == null ? this.getInitialSize() : this.initialSize;
        ...
        Long timeBetweenLogStatsMillis =
                this.timeBetweenLogStatsMillis == null ? this.getTimeBetweenLogStatsMillis() : this.timeBetweenLogStatsMillis;
        ...
        Long minEvictableIdleTimeMillis =
                this.minEvictableIdleTimeMillis == null ? this.getMinEvictableIdleTimeMillis() : this.minEvictableIdleTimeMillis;
        ...
        Long maxEvictableIdleTimeMillis =
                this.maxEvictableIdleTimeMillis == null ? this.getMaxEvictableIdleTimeMillis() : this.maxEvictableIdleTimeMillis;
        ...
        Boolean testWhileIdle = this.testWhileIdle == null ? this.getTestWhileIdle() : this.testWhileIdle;
        ...
        Boolean testOnBorrow = this.testOnBorrow == null ? this.getTestOnBorrow() : this.testOnBorrow;
        ...
        String validationQuery = this.validationQuery == null ? this.getValidationQuery() : this.validationQuery;
        if (validationQuery != null && validationQuery.length() > 0) {
            properties.setProperty(VALIDATION_QUERY, validationQuery);
        }

        Boolean useGlobalDataSourceStat = this.useGlobalDataSourceStat == null ? this.getUseGlobalDataSourceStat() : this.useGlobalDataSourceStat;
        ...
        Boolean asyncInit = this.asyncInit == null ? this.getAsyncInit() : this.asyncInit;
        if (asyncInit != null && asyncInit.equals(Boolean.TRUE)) {
            properties.setProperty(ASYNC_INIT, Boolean.TRUE.toString());
        }

        //filters单独处理，默认了stat
        String filters = this.filters == null ? this.getFilters() : this.filters;
        if (filters == null) {
            filters = STAT_STR;
        }
        ...
        Boolean clearFiltersEnable = this.clearFiltersEnable == null ? this.getClearFiltersEnable() : this.clearFiltersEnable;
        ...
        Boolean resetStatEnable = this.resetStatEnable == null ? this.getResetStatEnable() : this.resetStatEnable;
        ...
        Integer notFullTimeoutRetryCount =
                this.notFullTimeoutRetryCount == null ? this.getNotFullTimeoutRetryCount() : this.notFullTimeoutRetryCount;
        ...
        Integer maxWaitThreadCount = this.maxWaitThreadCount == null ? this.getMaxWaitThreadCount() : this.maxWaitThreadCount;
        ...
        Boolean failFast = this.failFast == null ? this.getFailFast() : this.failFast;
        if (failFast != null && failFast.equals(Boolean.TRUE)) {
            properties.setProperty(FAIL_FAST, Boolean.TRUE.toString());
        }

        Long phyTimeoutMillis = this.phyTimeoutMillis == null ? this.getPhyTimeoutMillis() : this.phyTimeoutMillis;
        ...
        Boolean keepAlive = this.keepAlive == null ? this.getKeepAlive() : this.keepAlive;
        if (keepAlive != null && keepAlive.equals(Boolean.TRUE)) {
            properties.setProperty(KEEP_ALIVE, Boolean.TRUE.toString());
        }

        Boolean poolPreparedStatements = this.poolPreparedStatements == null ? this.getPoolPreparedStatements() : this.poolPreparedStatements;
        ...
        Boolean initVariants = this.initVariants == null ? this.getInitVariants() : this.initVariants;
        if (initVariants != null && initVariants.equals(Boolean.TRUE)) {
            properties.setProperty(INIT_VARIANTS, Boolean.TRUE.toString());
        }

        Boolean initGlobalVariants = this.initGlobalVariants == null ? this.getInitGlobalVariants() : this.initGlobalVariants;
        ...
        Boolean useUnfairLock = this.useUnfairLock == null ? this.getUseUnfairLock() : this.useUnfairLock;
        ...
        Boolean killWhenSocketReadTimeout =
                this.killWhenSocketReadTimeout == null ? this.getKillWhenSocketReadTimeout() : this.killWhenSocketReadTimeout;
        ...
        Properties connectProperties = connectionProperties == null ? this.getConnectionProperties() : connectionProperties;
        ...
        Integer maxPoolPreparedStatementPerConnectionSize =
                this.maxPoolPreparedStatementPerConnectionSize == null ? this.getMaxPoolPreparedStatementPerConnectionSize()
        ...
        String initConnectionSqls = this.initConnectionSqls == null ? this.getInitConnectionSqls() : this.initConnectionSqls;
