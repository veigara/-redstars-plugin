...
public class AppcationTest {
    ...
    public static void save(){
        ...
        meterEntity.setCurrent(11.0f);
        meterEntity.setVoltage(116L);
        meterEntity.setPhase(0.9f);
    ...
    public static void bathchSave(){
        ...
        meterEntity1.setCurrent(12f);
        meterEntity1.setVoltage(116L);
        meterEntity1.setPhase(0.9f);
        ...
        meterEntity2.setCurrent(13f);
        meterEntity2.setVoltage(117L);
        meterEntity2.setPhase(0.9f);
